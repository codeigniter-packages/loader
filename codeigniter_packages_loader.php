...
trait codeigniter_packages_loader {
    ...
    public function package($package_name, $params = NULL, $object_name = NULL) {
        ...
        switch ($package->type) {
            ...
            case 'codeigniter-view':
                ...
                return $this->_package_view($package, $params, is_null($object_name) ? FALSE : $object_name);
        }
    ...
    private function _package_model($package, $object_name = NULL) {
        ...
        if (isset($CI->$object_name)) {
            show_error('codeigniter_packages_loader:The model name you are loading is the name of a resource that is already being used: ' . $object_name);
        }
